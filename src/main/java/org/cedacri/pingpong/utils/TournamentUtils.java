...
public class TournamentUtils
{
    ...
    public static int calculateMaxPlayers(BaseTournament tournament)
    {
    ...
    public static void movePlayersWithoutOpponent(int round, BaseTournament tournament)
    {
    ...
    private static void updateRatingAndSetTournamentWinnerRobinRound(BaseTournament tournament, PlayerService playerService)
    {
    ...
    private static void determineRobinRoundWinner(BaseTournament tournament, Map<Player, Integer> wonMatches, Map<Player, Integer> goalsScored, Map<Player, Integer> goalsLost)
    {
    ...
    private static void updateRatingAndSetTournamentWinnerOlympic(BaseTournament tournament, PlayerService playerService)
    {
    ...
    public static void checkAndUpdateTournamentWinner(BaseTournament tournament, TournamentService tournamentService, PlayerService playerService)
    {
        if (isTournamentReadyToFinish(tournament))
        {
            finalizeTournament(tournament, tournamentService, playerService, tournament.getTournamentType());
        }
        else
        {
    ...
    public static boolean isTournamentReadyToFinish(BaseTournament tournament)
    {
    ...
    public static String getErrorMessageForTournamentType(BaseTournament tournament)
    {
        return switch (tournament.getTournamentType())
        {
    ...
    private static void finalizeTournament(BaseTournament tournament, TournamentService tournamentService, PlayerService playerService, TournamentTypeEnum type)
    {
        tournament.setTournamentStatus(TournamentStatusEnum.FINISHED);

        if (type == TournamentTypeEnum.OLYMPIC)
        {
            updateRatingAndSetTournamentWinnerOlympic(tournament, playerService);
        }
        else
        {
            updateRatingAndSetTournamentWinnerRobinRound(tournament, playerService);
        }

        tournamentService.saveTournament(tournament);

        UI.getCurrent().navigate("home");
        NotificationManager.showInfoNotification(Constants.TOURNAMENT_WINNER_HAS_BEEN_DETERMINATE
