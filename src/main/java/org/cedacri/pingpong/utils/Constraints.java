...
public class Constraints {
    ...
    public static final List<String> TYPES_OF_TOURNAMENTS = List.of("BESTOFTHREE", "BESTOFFIVE", "BESTOFSEVEN");
    public static final List<String> PLAYING_HAND = List.of("LEFT", "RIGHT");

    public static final String TYPE_BEST_OF_THREE = "BEST_OF_THREE";
    public static final String TYPE_BEST_OF_FIVE = "BEST_OF_FIVE";
    public static final String TYPE_BEST_OF_SEVEN = "BEST_OF_SEVEN";
    public static final List<String> TOURNAMENT_TYPES = List.of(TYPE_BEST_OF_THREE, TYPE_BEST_OF_FIVE, TYPE_BEST_OF_SEVEN);
