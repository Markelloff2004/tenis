...
//
//class TournamentOlympicServiceTest {
//
//    @Mock
//    private BaseTournamentRepository tournamentRepository;
//    @Mock
...
//            assertTrue(tournamentOlympic1.getPlayers().stream().allMatch(player -> !player.getTournaments().contains(tournamentOlympic1)));
//        }
//
//        @Test
...
//            assertTrue(tournamentOlympic2.getPlayers().stream().allMatch(player -> !player.getTournaments().contains(tournamentOlympic2)));
//        }
//
//        @Test
...
//
//            verify(tournamentRepository, times(1)).deleteById(2);
//            assertTrue(tournamentOlympic2.getPlayers().stream().noneMatch(player -> player.getTournaments().contains(tournamentOlympic2)));
//        }
//
//        @Test
